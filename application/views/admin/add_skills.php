    ...
    <div class="page-content">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <?= form_open('admin/skills/update_skills',array('id'=>'addeditskills','name'=>'addeditskills','class'=>'form-horizontal','enctype'=>"multipart/form-data")); ?>
                <?= form_hidden(array('id'=>$id)); ?>
                <div class="control-group">
                    <label class="control-label" for="form-field-4">Skill Title</label>
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"text",'id'=>"title",'name'=>"title",'value'=>set_value('title'),'placeholder'=>"Skill Title")); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="form-field-4">Skill Image</label>
                    <div class="controls">
