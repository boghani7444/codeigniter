<div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?= base_url('admin/properties/properties_image/'.$properties_id); ?>">Properties Image</a>

                <span class="divider">
                    <i class="icon-angle-right arrow-icon"></i>
                </span>
            </li>
            <li class="active">Add Properties Image</li>
        </ul><!--.breadcrumb-->
    ...
    <div class="page-content">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <?= form_hidden(array('properties_id'=>$properties_id)); ?>
