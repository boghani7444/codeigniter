<div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Add/Edit <?= $page_title; ?></li>
        </ul><!--.breadcrumb-->
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"text",'id'=>"pname",'name'=>"pname",'value'=>$category['pname'],'placeholder'=>"Property Name")); ?>
                    </div>
                </div>
