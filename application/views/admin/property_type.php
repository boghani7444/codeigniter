...
//        App.init();
        ...
        oTable = $('#record_table').dataTable({
            ...
            "bServerSide": true,
            "bRedraw": true,
            "sAjaxSource": "<?php echo base_url(); ?>admin/property_type/property_type_list",
            "stateSave": true,
            "aoColumns": [
                {"mDataProp": "no", width: '12%'},
                {"mDataProp": "pname", width: '12%'},
        ...
        $('#record_table').on('click', '.status_btn', function() {
            ...
            if (r == true) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>admin/property_type/status_user",
                    data: { id: id },
                    beforeSend: function() {
        ...
        $('#record_table').on('click', '.delete_btn', function() {
            ...
            if (r == true) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>admin/property_type/delete_user",
                    data: { id: id },
                    beforeSend: function() {
