<div class="main-content">
    <div class="breadcrumbs" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Add Menu & Page Text</li>
        </ul><!--.breadcrumb-->
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"text",'id'=>"title",'name'=>"title",'value'=>set_value('title'),'placeholder'=>"Menu Title")); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="form-field-4">Menu URL</label>
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"text",'id'=>"page_link",'name'=>"page_link",'value'=>set_value('page_link'),'placeholder'=>"Page URL")); ?>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?= form_textarea(array('name'=>"sort_description",'id'=>"sort_description",'class'=>"input-xxlarge",'rows'=>"5",'placeholder'=>"Home Sort Description")); ?>
                    </div>
                </div>
                <div class="control-group">
