    ...
    <div class="page-content">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <?= form_hidden(array('old_icon'=>$services['service_icon'])); ?>
                <?= form_hidden(array('old_image'=>$services['service_image'])); ?>
                <div class="control-group">
                    <label class="control-label" for="form-field-4">Service Name</label>
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"text",'id'=>"service_name",'name'=>"service_name",'value'=>$services['service_name'],'placeholder'=>"Service Name")); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="form-field-4">Service Link</label>
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"text",'id'=>"service_link",'name'=>"service_link",'value'=>$services['service_link'],'placeholder'=>"Service Link")); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="form-field-4">Page Title</label>
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"text",'id'=>"page_title",'name'=>"page_title",'value'=>$services['page_title'],'placeholder'=>"Page Title")); ?>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"text",'id'=>"sort_keyword",'name'=>"sort_keyword",'value'=>$services['sort_keyword'],'placeholder'=>"Sort Keyword")); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="form-field-4">Service Icon</label>
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"file",'id'=>"service_icon",'name'=>"service_icon",'value'=>'')); ?>
                        <div style="float: right; position: absolute; margin-left: 29%; margin-top: -3.3%;" class="col-md-2">
                            
                            <span style="float: left; position: absolute; top: -20px; left: 10px;">Service Icon</span>
                            <img style="background: #000;margin-right: 15px;" width="100" src="<?= base_url('upload/services/icon/'.$services['service_icon']); ?>">
                            <span style="float: left; position: absolute; top: -20px; left: 150px;">Service Image</span>
                            <img width="150" src="<?= base_url('upload/services/images/'.$services['service_image']); ?>">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"file",'id'=>"service_image",'name'=>"service_image",'value'=>'')); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="form-field-4">Meta Title</label>
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"text",'id'=>"meta_title",'name'=>"meta_title",'value'=>$services['meta_title'],'placeholder'=>"Page Meta Title")); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="form-field-4">Meta Keyword</label>
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"text",'id'=>"meta_keyword",'name'=>"meta_keyword",'value'=>$services['meta_keyword'],'placeholder'=>"Page Meta Keyword")); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="form-field-4">Meta Description</label>
                    <div class="controls">
                        <?= form_textarea(array('name'=>"meta_description",'id'=>"meta_description",'class'=>"input-xxlarge",'rows'=>"5",'value'=>$services['meta_description'],'placeholder'=>"Page Meta Description")); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="form-field-4">Display Order</label>
                    <div class="controls">
                        <?= form_input(array('class'=>"input-large",'id'=>"d_order",'name'=>"d_order",'value'=>$services['d_order'],'placeholder'=>"Display Order")); ?>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?= form_textarea(array('name'=>"description",'id'=>"description",'cols'=>"55",'rows'=>"5",'wrap'=>"physical",'value'=>$services['description'])); ?>
                    </div>
                </div>
