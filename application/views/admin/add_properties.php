            ...
            <div class="span12">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <?= form_dropdown('categories_id', $array, set_value('categories_id', 'id="categories_id" style="height: 30px;"'),array("class"=>"input-xxlarge")); ?>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <?= form_dropdown('property_type_id', $array_pro, set_value('property_type_id', 'id="property_type_id" style="height: 30px;"'),array("class"=>"input-xxlarge")); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="form-field-4">Properties Name</label>
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"text",'id'=>"properties_name",'name'=>"properties_name",'value'=>set_value('properties_name'),'placeholder'=>"Properties Name")); ?>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"text",'id'=>"image_alt",'name'=>"image_alt",'value'=>set_value('image_alt'),'placeholder'=>"Image Alt Tag")); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="form-field-4">Image Title</label>
                    <div class="controls">
                        <?= form_input(array('class'=>"input-xxlarge",'type'=>"text",'id'=>"image_title",'name'=>"image_title",'value'=>set_value('image_title'),'placeholder'=>"Image Title Tag")); ?>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <?= form_dropdown('state', $array_state, set_value('state'),array('id'=>'state',"class"=>"input-xxlarge",'onchange'=>'getcity(this.value);')); ?>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        $array_city = array();
                        ?>
                        <?= form_dropdown('city', $array_city, set_value('city'),array('id'=>'city',"class"=>"input-xxlarge")); ?>
                    </div>
                </div>
                <div class="control-group">
...
<script type="text/javascript">
    $('#addeditproperties').validate({
        ...
        rules: {
            ...
            properties_image: { required: true },
            state: { required: true },
            city: { required: true },
        },
        messages: {
            ...
            properties_image: {
                required: "Please Select Properties Image.",
            },
            state: {
