...
//        App.init();
        ...
        oTable = $('#record_table').dataTable({
            ...
            "bServerSide": true,
            "bRedraw": true,
            "sAjaxSource": "<?php echo base_url(); ?>admin/properties/properties_list",
            "stateSave": true,
            "aoColumns": [
                {"mDataProp": "no", width: '12%'},
                {"mDataProp": "properties_name", width: '12%'},
                {"mDataProp": "cname", width: '5%'},
                {"mDataProp": "pname", width: '5%'},
        ...
        $('#record_table').on('click', '.status_btn', function() {
            ...
            if (r == true) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>admin/properties/status_user",
                    data: { id: id },
                    beforeSend: function() {
        ...
        $('#record_table').on('click', '.delete_btn', function() {
            ...
            if (r == true) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>admin/properties/delete_user",
                    data: { id: id },
                    beforeSend: function() {
